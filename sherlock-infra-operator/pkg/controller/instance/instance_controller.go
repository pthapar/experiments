...
import (
	...
	sherlockv1alpha1 "sherlock-infra-operator/pkg/apis/sherlock/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &sherlockv1alpha1.Instance{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &sherlockv1alpha1.Instance{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileInstance) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &sherlockv1alpha1.Instance{}
	...
	// TODO: implement something like https://github.com/paulczar/gcp-cloud-compute-operator/tree/master/pkg/controller/instance
	...
	runResult, err := svc.RunInstances(&ec2.RunInstancesInput{
		...
		ImageId:      aws.String("ami-073318903a52a14eb"),
	...
	if errtag != nil {
		log.Info("Could not create tags for instance", runResult.Instances[0].InstanceId, errtag)
		return reconcile.Result{}, err
	}
...
func newPodForCR(cr *sherlockv1alpha1.Instance) *corev1.Pod {
